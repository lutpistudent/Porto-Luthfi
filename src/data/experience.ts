...
export const experiences: Experience[] = [
  {
    ...
    period: '2025 - Present',
    description:
      'Merancang dan membangun beberapa sistem informasi sekolah serta aplikasi web sederhana untuk mengoptimalkan administrasi internal.',
    contributions: [
  ...
  },
  {
    ...
    period: '2024 - 2025',
    description:
      'Mengemban tanggung jawab ganda dalam pengelolaan finansial kegiatan dan membangun hubungan komunikasi eksternal sekolah.',
    contributions: [
  ...
  },
  {
    ...
    period: '2024',
    description:
      'Merancang program penggalangan dana kreatif guna menyokong pendanaan acara pameran teknologi tahunan sekolah.',
    contributions: [
  ...
  },
  {
    ...
    period: '2023 - Present',
    description:
      'Mengeksplorasi dunia pengembangan aplikasi mandiri untuk mengasah skill coding dan problem solving secara riil.',
    contributions: [
